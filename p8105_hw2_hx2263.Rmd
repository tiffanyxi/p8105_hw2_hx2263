...
2.The median of the number of grocery bags in 2014, 2015, 2016 are `r median(trash_wheel$grocery_bags[which(trash_wheel$year == 2014)])`, `r median(trash_wheel$grocery_bags[which(trash_wheel$year == 2015)])` and `r median(trash_wheel$grocery_bags[which(trash_wheel$year == 2016)])`.
